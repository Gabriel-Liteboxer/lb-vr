...
public class RevolvingMenuParent : MonoBehaviour
{
    ...
    private MenuItem[] MenuItemTiles;
    ...
    private void Start()
    {
        ...
        MenuItemTiles = new MenuItem[SongLibrary.Length];
    ...
    private void Update()
    {
        ...
        for (int i = 0; i < MenuItemTiles.Length; i++)
        {
            ...
            MenuItemTiles[i].MenuItemMat.material.color = new Color(1, 1, 1, transparency);
            ...
            if (transparency == 0)
            {
                MenuItemTiles[i].MenuItemMat.enabled = false;

            }
            else if (!MenuItemTiles[i].MenuItemMat.enabled)
            {
                MenuItemTiles[i].MenuItemMat.enabled = true;
